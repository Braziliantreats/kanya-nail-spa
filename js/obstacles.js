  ...
  GR.Spawner = class {
    constructor(scene) {
      ...
      this.mats = {
        ...
        wood: new THREE.MeshStandardMaterial({ color: 0x8a6b48, roughness: 0.95 }),
        ...
        barrel: new THREE.MeshStandardMaterial({ color: 0x3f7d4a, roughness: 0.6, metalness: 0.2 }),
        dark: new THREE.MeshStandardMaterial({ color: 0x23262b, roughness: 0.8 }),
        tractor: new THREE.MeshStandardMaterial({ color: 0x4c8c3c, roughness: 0.7 }),
        tractorAccent: new THREE.MeshStandardMaterial({ color: 0xe9c24c, roughness: 0.7 }),
        van: new THREE.MeshStandardMaterial({ color: 0x3e8e7e, roughness: 0.6 }),
        vanDecal: new THREE.MeshBasicMaterial({ map: vanTexture() }),
        duck: new THREE.MeshBasicMaterial({ map: duckSignTexture() }),
        herb: new THREE.MeshStandardMaterial({ color: 0x2f6b34, roughness: 1 }),
        rope: new THREE.MeshStandardMaterial({ color: 0xd8cba8, roughness: 1 }),
        white: new THREE.MeshStandardMaterial({ color: 0xf4f1ea, roughness: 0.6 }),
        red: new THREE.MeshStandardMaterial({ color: 0xd64545, roughness: 0.5 }),
